...
const Footer = () => {
  ...
  <div className="flex-1 flex flex-col justify-start mr-10">
    <img src={logo} alt="choobank" className="w-[266px] h-[72px] object-contain" />
  ...
  md:mt-0 mt-10 ">
   ...
   footerLinks.map((footerLink)=>(
    ...
    <div className="w-full flex justify-between items-center flex-col md:flex-row pt-6 border-t-[1px] 
    border-t-[#3f3r45]">
