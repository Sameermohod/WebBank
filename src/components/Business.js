...
const FeatureCards = ({icon,title,content,index}) =>{

  return(

  <div className={`flex flex-row p-6 rounded-[20px] ${index!==-1?"mb-6":"mb-0"} feature-card`}>
...
const Business = () => { 
  ...
  <section id="features" className={layout.section}>
    ...
    hidden" /> we'll handle
     ...
     financial life by building credit, earning reward and saving money.
     But with hundreds of credit cards o the market.</p>
     <Button styles="mt-10"/>
    </div>
